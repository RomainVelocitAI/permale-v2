                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <label 
                          ...
                          className="flex items-center justify-center w-full px-6 py-12 border border-dashed border-[#363d43]/30 rounded-sm cursor-pointer hover:border-[#acae9f] hover:bg-[#acae9f]/5 transition-all duration-300 bg-white"
                        >
